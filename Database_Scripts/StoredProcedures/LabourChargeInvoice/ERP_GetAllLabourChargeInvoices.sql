...
-- Description: Gets all Labour Charge Invoices (INM_TYPE='OutJWINM') with filtering, searching, sorting, and pagination
-- =============================================
CREATE PROCEDURE [dbo].[ERP_GetAllLabourChargeInvoices]
    @CompanyId INT,
    @CustomerId INT = NULL,
...
BEGIN
    ...
    DECLARE @WhereClause NVARCHAR(MAX) = 'WHERE I.INM_CM_CODE = @CompanyId AND I.INM_TYPE = ''OutJWINM''';
    ...
    EXEC sp_executesql @CountSQL,
        N'@CompanyId INT, @CustomerId INT, @CustomerPoCode INT, @InvoiceDateFrom DATETIME,
          @InvoiceDateTo DATETIME, @SearchTerm NVARCHAR(200), @TotalCount INT OUTPUT',
        @CompanyId, @CustomerId, @CustomerPoCode, @InvoiceDateFrom, @InvoiceDateTo,
        @SearchTerm, @TotalCount OUTPUT;
    ...
    EXEC sp_executesql @SQL,
        N'@CompanyId INT, @CustomerId INT, @CustomerPoCode INT, @InvoiceDateFrom DATETIME,
          @InvoiceDateTo DATETIME, @SearchTerm NVARCHAR(200),
