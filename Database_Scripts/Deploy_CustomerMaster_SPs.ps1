param(
    [string]$ScriptsPath = "Database_Scripts\StoredProcedures\CustomerMaster"
)

Write-Host "`n======================================" -ForegroundColor Cyan
Write-Host "Deploying Customer Master Stored Procedures" -ForegroundColor Cyan
Write-Host "======================================`n" -ForegroundColor Cyan
...
# Get all SQL files in the CustomerMaster directory
