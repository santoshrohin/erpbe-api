param(
    [string]$ScriptsPath = "Database_Scripts\StoredProcedures\TaxInvoice"
)

Write-Host "`n======================================" -ForegroundColor Cyan
Write-Host "Deploying Tax Invoice Stored Procedures" -ForegroundColor Cyan
Write-Host "======================================`n" -ForegroundColor Cyan
...
# Get all SQL files in the TaxInvoice directory
