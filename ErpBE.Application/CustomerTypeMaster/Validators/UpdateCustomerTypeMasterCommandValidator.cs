...
{
    public class UpdateCustomerTypeMasterCommandValidator : AbstractValidator<UpdateCustomerTypeMasterCommand>
    {
        private readonly ICustomerTypeMasterRepository _repository;

        public UpdateCustomerTypeMasterCommandValidator(ICustomerTypeMasterRepository repository)
        {
