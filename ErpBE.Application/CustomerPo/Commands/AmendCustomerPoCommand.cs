...
/// <summary>
/// Command to amend an existing Customer PO.
/// Mirrors legacy CustomerPO.aspx.cs AMEND path: archives master+details,
/// increments CPOM_AM_COUNT, and replaces detail lines.
/// </summary>
public class AmendCustomerPoCommand : IRequest<CustomerPoMasterDto>
{
