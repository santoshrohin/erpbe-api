...
{
    /// <summary>
    /// Request model for creating a new Tax Invoice (with ALL fields)
    /// </summary>
    public class CreateTaxInvoiceRequest
    {
        ...
        public int? CustomerPoCode { get; set; } // Mandatory as per business rules
        
        #endregion
        
        #region Optional Header Fields
        
        public byte? InvoiceType { get; set; } = 0; // Default 0 for Tax Invoice
        public string? Type { get; set; } = "TAXINV";
        ...
        public List<CreateTaxInvoiceDetailRequest> InvoiceDetails { get; set; } = new List<CreateTaxInvoiceDetailRequest>();
        
        #endregion
    }
    
    /// <summary>
    /// Request model for Tax Invoice line item
    /// </summary>
    public class CreateTaxInvoiceDetailRequest
    {
        ...
        public string? DeliveryChallanDates { get; set; }
        public string? ExciseNumbers { get; set; }
        
        // Process & GIN
        public int? ProcessCode { get; set; }
        public string? GinNumber { get; set; }
        public DateTime? GinDate { get; set; }
        public double? GinReceipt { get; set; }
        public decimal? MrCode { get; set; }
        public double? GinAcceptance { get; set; }
        ...
        public string? Remarks { get; set; }
        public int? ItemWarehouseCode { get; set; }
        ...
        public double? NumberOfBarrels { get; set; }
        public string? NumberOfPackagesDescription { get; set; }
        public string? ContainerNumber { get; set; }
        
        // Amortization
        public double? RefundableQuantity { get; set; }
